...
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection import box_coder
...
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection import matcher
