...
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.builders import image_resizer_builder
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos import image_resizer_pb2
