...
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.builders import optimizer_builder
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos import optimizer_pb2
