...
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.builders import matcher_builder
...
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos import matcher_pb2
