...
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection import trainer
...
from pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos import train_pb2
