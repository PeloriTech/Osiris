...
_FASTERRCNN.fields_by_name['image_resizer'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.image_resizer_pb2._IMAGERESIZER
_FASTERRCNN.fields_by_name['feature_extractor'].message_type = _FASTERRCNNFEATUREEXTRACTOR
_FASTERRCNN.fields_by_name['first_stage_anchor_generator'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.anchor_generator_pb2._ANCHORGENERATOR
_FASTERRCNN.fields_by_name['first_stage_box_predictor_conv_hyperparams'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.hyperparams_pb2._HYPERPARAMS
_FASTERRCNN.fields_by_name['second_stage_box_predictor'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.box_predictor_pb2._BOXPREDICTOR
_FASTERRCNN.fields_by_name['second_stage_post_processing'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.post_processing_pb2._POSTPROCESSING
_FASTERRCNN.fields_by_name['hard_example_miner'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.losses_pb2._HARDEXAMPLEMINER
