...
import pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.anchor_generator_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.anchor_generator_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.box_coder_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.box_predictor_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.hyperparams_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.image_resizer_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.matcher_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.losses_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.post_processing_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.region_similarity_calculator_pb2.DESCRIPTOR, ])
...
_SSD.fields_by_name['image_resizer'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.image_resizer_pb2._IMAGERESIZER
_SSD.fields_by_name['feature_extractor'].message_type = _SSDFEATUREEXTRACTOR
_SSD.fields_by_name['box_coder'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.box_coder_pb2._BOXCODER
_SSD.fields_by_name['matcher'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.matcher_pb2._MATCHER
_SSD.fields_by_name['similarity_calculator'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.region_similarity_calculator_pb2._REGIONSIMILARITYCALCULATOR
_SSD.fields_by_name['box_predictor'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.box_predictor_pb2._BOXPREDICTOR
_SSD.fields_by_name['anchor_generator'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.anchor_generator_pb2._ANCHORGENERATOR
_SSD.fields_by_name['post_processing'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.post_processing_pb2._POSTPROCESSING
_SSD.fields_by_name['loss'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.losses_pb2._LOSS
_SSDFEATUREEXTRACTOR.fields_by_name['conv_hyperparams'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.hyperparams_pb2._HYPERPARAMS
