...
from pipeline_manager.VideoProcessor.SimpleObjectDetection import object_detection
import pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.mean_stddev_box_coder_pb2
import pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.square_box_coder_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.faster_rcnn_box_coder_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.mean_stddev_box_coder_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.square_box_coder_pb2.DESCRIPTOR, ])
...
_BOXCODER.fields_by_name['faster_rcnn_box_coder'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.faster_rcnn_box_coder_pb2._FASTERRCNNBOXCODER
_BOXCODER.fields_by_name['mean_stddev_box_coder'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.mean_stddev_box_coder_pb2._MEANSTDDEVBOXCODER
_BOXCODER.fields_by_name['square_box_coder'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.square_box_coder_pb2._SQUAREBOXCODER
