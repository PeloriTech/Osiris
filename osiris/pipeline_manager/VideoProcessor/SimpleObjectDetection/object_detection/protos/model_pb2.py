...
import pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.faster_rcnn_pb2
import pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.ssd_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.faster_rcnn_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.ssd_pb2.DESCRIPTOR, ])
...
_DETECTIONMODEL.fields_by_name['faster_rcnn'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.faster_rcnn_pb2._FASTERRCNN
_DETECTIONMODEL.fields_by_name['ssd'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.ssd_pb2._SSD
