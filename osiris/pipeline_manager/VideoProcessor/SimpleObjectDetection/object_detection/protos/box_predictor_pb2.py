...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[libs.VideoProcessor.SimpleObjectDetection.object_detection.protos.hyperparams_pb2.DESCRIPTOR, ])
...
_CONVOLUTIONALBOXPREDICTOR.fields_by_name['conv_hyperparams'].message_type = libs.VideoProcessor.SimpleObjectDetection.object_detection.protos.hyperparams_pb2._HYPERPARAMS
_MASKRCNNBOXPREDICTOR.fields_by_name['fc_hyperparams'].message_type = libs.VideoProcessor.SimpleObjectDetection.object_detection.protos.hyperparams_pb2._HYPERPARAMS
_MASKRCNNBOXPREDICTOR.fields_by_name['conv_hyperparams'].message_type = libs.VideoProcessor.SimpleObjectDetection.object_detection.protos.hyperparams_pb2._HYPERPARAMS
_RFCNBOXPREDICTOR.fields_by_name['conv_hyperparams'].message_type = libs.VideoProcessor.SimpleObjectDetection.object_detection.protos.hyperparams_pb2._HYPERPARAMS
