...
import pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.input_reader_pb2
import pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.train_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.eval_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.input_reader_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.model_pb2.DESCRIPTOR,
                pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.train_pb2.DESCRIPTOR, ])
...
_TRAINEVALPIPELINECONFIG.fields_by_name['model'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.model_pb2._DETECTIONMODEL
_TRAINEVALPIPELINECONFIG.fields_by_name['train_config'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.train_pb2._TRAINCONFIG
_TRAINEVALPIPELINECONFIG.fields_by_name['train_input_reader'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.input_reader_pb2._INPUTREADER
_TRAINEVALPIPELINECONFIG.fields_by_name['eval_config'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.eval_pb2._EVALCONFIG
_TRAINEVALPIPELINECONFIG.fields_by_name['eval_input_reader'].message_type = pipeline_manager.VideoProcessor.SimpleObjectDetection.object_detection.protos.input_reader_pb2._INPUTREADER
